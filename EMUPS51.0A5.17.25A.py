...
class Emulator:
    ...
    def load_demo(self):
        ...
        instructions = [
            ...
            # Game loop start (address 16)
            (5 << 24) | (0 << 20) | (1 << 12) | (7 << 9) | (0 << 6) | (0 << 3) | 7,  # SETPIXEL R0, R1, 7, 0, 0, 7 (red pixel)
            (2 << 24) | (0 << 20) | (0 << 16) | (2 << 12),  # ADD R0, R0, R2 (update x)
            (2 << 24) | (1 << 20) | (1 << 16) | (3 << 12),  # ADD R1, R1, R3 (update y)
            # Check bounds and reverse direction
            (7 << 24) | (0 << 20) | (4 << 16) | 16,  # BEQ R0, R4 (127), offset 16 (reverse x)
            (7 << 24) | (1 << 20) | (4 << 16) | 24,  # BEQ R1, R4 (127), offset 24 (reverse y)
            (6 << 24) | 16,  # JMP 16 (loop back)
            # Reverse x direction
            (1 << 24) | (2 << 20) | (255 << 16),  # MOV R2, 255 (-1 in 8-bit)
            (6 << 24) | 16,  # JMP 16
            # Reverse y direction
            (1 << 24) | (3 << 20) | (255 << 16),  # MOV R3, 255 (-1)
            (6 << 24) | 16,  # JMP 16
        ]
