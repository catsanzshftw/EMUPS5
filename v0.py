...
class CPU:
    ...
    def execute_instruction(self, instruction):
        ...
        if opcode == 0:  # NOP
            ...
            log_queue.put(('error', f"Unknown opcode: {opcode}"))
        self.pc += 8
...
class Emulator:
    def __init__(self):
        ...
        self.cpu.memory = self.memory  # Reference for CPU to access memory
    ...
    def load_demo(self):
        instructions = [
            (4 << 56) | (10 << 48) | (10 << 40) | (255 << 32) | (0 << 24) | (0 << 16) | (255 << 8),
            (4 << 56) | (20 << 48) | (20 << 40) | (0 << 32) | (255 << 24) | (0 << 16) | (255 << 8),
            (4 << 56) | (30 << 48) | (30 << 40) | (0 << 32) | (0 << 24) | (255 << 16) | (255 << 8),
        ]
        for i, inst in enumerate(instructions):
            self.memory.write_uint64(i * 8, inst)
        self.game_loaded = True
        log_queue.put(('success', 'Demo program loaded.'))
